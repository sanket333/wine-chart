...
import { filterDataByAxis, getOption } from './utils.js'
...
function App() {
  ...
  useEffect(() => {
    ...
    const scatterData = filterDataByAxis(chartData, 'Color intensity', 'Hue');
    const barData = filterDataByAxis(chartData, 'Alcohol', 'Malic Acid');
